...
import styles from "./cssPublicacion";

export default function Publicacion({ data, onPress }) {
  return (
    <TouchableOpacity style={styles.container} onPress={onPress}>
      <View style={styles.avatarContainer}>
        ...
        <View style={[styles.iconoBadge, styles.bgMorado]}>
      ...
      {!data.visto && <View style={styles.puntoMorado} />}
    </TouchableOpacity>
  );
}
